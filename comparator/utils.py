...
# Functions to run Comparator

def verifyFlag(fType, f):
    if(fType == '-a'):
        diff = ['b', 'l', 'r', 'a']
        if f in diff: 
            return f
...
def printValues(nr_queens, approach, pres_sol):
    print(values)
    print('#  Queens (-n): ', nr_queens)
    print('#  Approach (-a): ', approach)
    print(line)
    print()
...
def verifyValues(nr_queens, approach, pres_sol):
    if(nr_queens == 'Invalid' or approach == 'Invalid' or pres_sol == 'Inavlid'):
        return False
    elif(approach == 'b' and nr_queens > 12):
        return False
    elif(approach == 'l' and nr_queens > 30):
        return False
    else:
        return True

def runComparator(nr_queens, approach, pres_sol):
    command = 'time -p python3.5 queen-chess.py '
    if approach == 'a':
        print('\n ==== Brute Force ==== ')
        os.system(command + str(nr_queens) + ' b ' + str(pres_sol))
        print('\n ==== Leftmost Column ==== ')
        os.system(command + str(nr_queens) + ' l ' + str(pres_sol))
        print('\n ==== Rand(Leftmost Column) ==== ')
        os.system(command + str(nr_queens) + ' r ' + str(pres_sol))
    else:
        if approach == 'b':
            print('\n ==== Brute Force ==== ')
        elif approach == 'l':
            ...
            print('\n ==== Rand(Leftmost Column) ==== ')
        os.system(command + str(nr_queens) + ' ' + approach + ' ' + str(pres_sol))
...
def print_solution_queen(goal_node):
	board = goal_node.state.board
	print('Solution:')
	length = len(board)
